...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("flask_pickle_loads.py", "secscan.python.pickle-loads", "KISA-043"),
        ("flask_open_user_path.py", "secscan.python.open-user-path", "KISA-003"),
        ("flask_os_system.py", "secscan.python.os-system", "KISA-005"),
        ("flask_eval.py", "secscan.python.eval", "KISA-002"),
        ("flask_exec.py", "secscan.python.exec", "KISA-002"),
        ("flask_pickle_load.py", "secscan.python.pickle-load", "KISA-043"),
        ("flask_path_open.py", "secscan.python.path-open", "KISA-003"),
        ("flask_subprocess_run_shell.py", "secscan.python.subprocess-run-shell", "KISA-005"),
        ("flask_pickle_unpickler_load.py", "secscan.python.pickle-unpickler-load", "KISA-043"),
        ("flask_subprocess_popen_shell.py", "secscan.python.subprocess-popen-shell", "KISA-005"),
        ("flask_subprocess_call_shell.py", "secscan.python.subprocess-call-shell", "KISA-005"),
        (
            "flask_subprocess_check_call_shell.py",
            "secscan.python.subprocess-check-call-shell",
            "KISA-005",
        ),
        (
            "flask_subprocess_check_output_shell.py",
            "secscan.python.subprocess-check-output-shell",
            "KISA-005",
        ),
        ("flask_os_popen.py", "secscan.python.os-popen", "KISA-005"),
        (
            "flask_subprocess_output_shell.py",
            "secscan.python.subprocess-output-shell",
            "KISA-005",
        ),
        ("flask_local_propagation.py", "secscan.python.os-system", "KISA-005"),
        ("flask_converging_sources.py", "secscan.python.os-system", "KISA-005"),
        ("RuntimeExecServlet.java", "secscan.java.runtime-exec", "KISA-005"),
        ("JdbcStatementSqlServletJavax.java", "secscan.java.jdbc-statement-sql", "KISA-001"),
        ("ProcessBuilderServletJakarta.java", "secscan.java.process-builder", "KISA-005"),
        ("ServletLocalPropagation.java", "secscan.java.runtime-exec", "KISA-005"),
        ("ServletConvergingSources.java", "secscan.java.runtime-exec", "KISA-005"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("safe_flask_fixed_value.py", "secscan.python.os-system"),
        ("safe_flask_unrelated_request.py", "secscan.python.os-system"),
        ("safe_flask_unrelated_flask.py", "secscan.python.os-system"),
        ("SafeServletFixedValue.java", "secscan.java.runtime-exec"),
        ("SafeServletUnrelatedReceiver.java", "secscan.java.runtime-exec"),
    ],
)
